...
return [
    ' and ' => 'y',
    '(not set)' => '(no inicializado)',
    'An internal server error occurred.' => 'Ha ocurrido un error interno de servidor',
    'Are you sure you want to delete this item?' => '¿Está seguro que desea borrar este ítem?',
    'Delete' => 'Borrar',
    'Error' => 'Error',
    'File upload failed.' => 'La subida del fichero ha fallado',
    'Home' => 'Inicio',
    ...
    'Missing required arguments: {params}' => 'Argumentos requeridos no encontrados: {params}',
    'Missing required parameters: {params}' => 'Parámetros requeridos no encontrados: {params}',
    'No' => 'No',
    'No results found.' => 'Ningún resultado encontrado',
    'Only files with these MIME types are allowed: {mimeTypes}.' => 'Solo los ficheros con este tipo MIME están permitidos: {mimeTypes}',
    'Only files with these extensions are allowed: {extensions}.' => 'Solo los ficheros con las extensiones siguientes están permitidos: {extensions}',
    ...
    'The combination {values} of {attributes} has already been taken.' => ' La conbinación de {values} of {attributes} ya está bloqueda',
    'The file "{file}" is not an image.' => 'El fichero "{file} no es una imagen"',
    'The file "{file}" is too big. Its size cannot exceed {formattedLimit}.' => 'El fichero "{file}" es demasiado grande. El tamaño no puede exceder de {formattedLimit}.',
    'The file "{file}" is too small. Its size cannot be smaller than {formattedLimit}.' => 'El fichero "{file}" es demasiado pequeño. El tamaño mínimo es {formattedLimit}.',
    'The format of {attribute} is invalid.' => 'El formato de {atributo} es inválido',
